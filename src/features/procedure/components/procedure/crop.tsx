    ...
    <Box ref={ref} display="flex" flexDirection="column">
      ...
      >
        ...
        <Box
          display="flex"
          flexDirection={{ xs: "column", sm: "row", md: "row" }}
          height={{ xs: "auto", sm: "100%", md: "100%" }} // PC: 940px, Mobile: auto
          overflow="hidden"
          gap={4}
          flexWrap="wrap" // Mobile tránh tràn nội dung
        >
          ...
          >
            ...
            >
              ...
              hại, đảm bảo an toàn cho sức khỏe. Đạt độ chín hoàn hảo, mọng
              nước, ngọt thanh tự nhiên, mang lại trải nghiệm tươi ngon đúng
              chuẩn.
            </Typography>
            <Box
              display="flex"
