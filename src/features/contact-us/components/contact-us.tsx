...
export const ContactUs = (pros: any) => {
  ...
  const center = {
    lat: 10.8231, // Vĩ độ của vị trí trung tâm bản đồ
    lng: 106.6297, // Kinh độ của vị trí trung tâm bản đồ
  };
    ...
    <Box ref={ref} display="flex" flexDirection="column">
        ...
        >
          ...
          >
            ...
            <Box
              ...
              sx={{
                position: "absolute",
                width: { xs: "0px", sm: "240px", md: "440px" },
                height: { xs: "0px", sm: "240px", md: "440px" },
                top: "0px",
                right: "-50px",
                opacity: 0.7,
              }}
      ...
      <LoadScript googleMapsApiKey="YOUR_GOOGLE_MAPS_API_KEY">
        <GoogleMap mapContainerStyle={containerStyle} center={center} zoom={15}>
          {/* Các thành phần con như Marker có thể được thêm vào đây */}
        </GoogleMap>
      </LoadScript>
    </Box>
  );
