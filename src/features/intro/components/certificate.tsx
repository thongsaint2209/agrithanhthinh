...
export const Certificate = (pros: any) => {
        ...
        >
          ...
          >
            ...
            <Box
              ...
              sx={{
                position: "absolute",
                width: { xs: "0px", sm: "220px", md: "280px" },
                height: { xs: "0px", sm: "220px", md: "280px" },
                top: "0px",
                right: "0px",
                opacity: 0.7,
              }}
            ...
            <Box ref={boxRef} pb={{ xs: 8, sm: 16, md: 16 }} zIndex={8}>
              ...
              >
                Để đảm bảo sản phẩm luôn đạt chất lượng cao nhất, Thành Thịnh
                Agri tuân thủ nghiêm ngặt các tiêu chuẩn VietGAP, GlobalGAP và
                đang từng bước hướng đến mô hình nông nghiệp hữu cơ. Việc áp
                dụng các tiêu chuẩn này giúp sản phẩm đảm bảo an toàn thực phẩm,
                truy xuất nguồn gốc rõ ràng và đáp ứng yêu cầu khắt khe của các
                thị trường khó tính. Bên cạnh đó, HTX cũng cam kết hạn chế tối
                đa việc sử dụng hóa chất, thay thế bằng các phương pháp sinh học
                thân thiện với môi trường. Quy trình sản xuất được giám sát chặt
                chẽ từ khâu chọn giống, chăm sóc, thu hoạch đến bảo quản sau thu
                hoạch, giúp sản phẩm luôn giữ được độ tươi ngon và giá trị dinh
                dưỡng cao nhất khi đến tay người tiêu dùng.
              </Typography>
