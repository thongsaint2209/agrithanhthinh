        ...
        >
          ...
          >
            ...
            <Box ref={boxRef} pb={{ xs: 8, sm: 16, md: 16 }} zIndex={8}>
              ...
              >
                Thành Thịnh Agri hướng đến phát triển một nền nông nghiệp sạch,
                an toàn và bền vững, góp phần nâng cao giá trị nông sản Việt
                Nam. Với mong muốn mang đến cho người tiêu dùng những sản phẩm
                chất lượng cao, không dư lượng hóa chất độc hại, chúng tôi áp
                dụng các phương pháp canh tác hiện đại kết hợp với quy trình sản
                xuất khép kín. Bên cạnh đó, Thành Thịnh Agri còn đặt mục tiêu mở
                rộng thị trường xuất khẩu, đưa cam, bưởi và các nông sản khác
                của Việt Nam vươn xa trên thị trường quốc tế.
              </Typography>
